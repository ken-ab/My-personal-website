  ...
  return (
    <main className="page-shell finance-result-page page-enter">
      <header className="finance-result-hero">
        <div>
          <p className="finance-result-kicker">{bilingual(language, "ARCHIVED SYSTEM OUTPUT", "实际运行输出")}</p>
          <h1>{report.title}</h1>
          <p className="finance-result-intro">
            {bilingual(
              language,
              "This is a raw report generated by Finance-Agent during a complete analysis run. It demonstrates how the system consolidates fundamental, technical, valuation, and news analysis.",
      ...
      <aside className="finance-result-notice" role="note">
        ...
        <div>
          ...
          <p>
            {bilingual(
              language,
              "This page preserves one historical run, including the data gaps and model judgments recorded in the report. The analysis is dated January 17, 2026 and documents the system's output format. It does not represent a current market view and is not investment advice. The original report is retained in Chinese.",
